...
* [subset_selection.md](./1_search_space/subset_selection.md) — Concrete application of subset selection for the 18-vehicle scenario.
...
* [subset_selection.md](./2_generalization/subset_selection.md) — Generalized algebraic formulation for variable N (subset selection / knapsack).
