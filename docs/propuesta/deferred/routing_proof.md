...
This document provides the mathematical proof showing why the routing paths for the globally optimized solution in [optimized.md](../example/solution/4_optimized/optimized.md) are the absolute global optimum for the 15-vehicle assignment.
