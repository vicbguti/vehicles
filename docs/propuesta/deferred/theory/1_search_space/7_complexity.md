...
This demonstrates that for the toy N=16/available=18 case the bin-packing enumeration alone is trivial to exhaust, which matches the discussion in [06_feasibility.md](../../../06_feasibility.md) about small-N tractability and why routing is the dominant contributor to intractability.
