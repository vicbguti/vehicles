...
The mathematical proof of why subsets of sizes 18 and 17 are infeasible, and how size 16 is determined to be the maximum partitionable subset, is detailed in [3_capacity_constraints.md](./3_capacity_constraints.md) and [4_bin_packing.md](../2_generalization/3_partitioning/bin_packing.md).
