...
This directory contains documents exploring the combinatorial search space, scenario parameters, capacity constraints, bin packing proofs, complexity, and intractability limits of the 18-vehicle fleet routing problem.

## 📂 Documents

* [1_scenario_parameters.md](./1_scenario_parameters.md) — Base variables, vehicle classes, and fleet capacity limits.
* [2_subset_selection.md](./2_subset_selection.md) — Mathematical evaluation of subset selection space size.
