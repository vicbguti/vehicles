...
Formal constraints: [deferred/theory/2_generalization/3_partitioning/bin_packing.md](../propuesta/deferred/theory/2_generalization/3_partitioning/bin_packing.md).
...
* Scenarios from real SRI weeks ([03_data.md](../propuesta/03_data.md)).
...
Implemented by us for comparison ([05_evaluation.md](../propuesta/05_evaluation.md)):

* **Status quo** — regional proximity grouping ([example/problem/3_status_quo/status_quo.md](../propuesta/example/problem/3_status_quo/status_quo.md))
* **Greedy** — first-fit / canton-order ([example/problem/2_greedy/greedy.md](../propuesta/example/problem/2_greedy/greedy.md)); evaluate **grouping only**, not route km
...
See [02_scope.md](./02_alcance_original.md) for honest limits on optimality claims.
