...
> [`05_hallazgos_para_el_equipo.md`](../decisiones/01_hallazgos_transversales.md).
...
> [`03_resultados_mlp.md`](../modelo/resultados.md), medidas ya sobre el dataset ordenado. Dos
...
+    # no cambian -- ver docs/modelo/canonicalizacion.md.
+    return sorted(caps)
```
