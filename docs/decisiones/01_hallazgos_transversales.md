...
> [`06_canonicalizacion_y_etiquetado.md`](../modelo/canonicalizacion.md). **Lean ése
...
3. **Decidir en grupo si ordenamos la flota en `scenarios.py`.** Cuesta 8 minutos de
   ...
   [`03_resultados_mlp.md`](../modelo/resultados.md).
...
Todo bajo `src/modeling/`, con 80 pruebas en `tests/modeling/` en ese momento (hoy el repositorio tiene **479**, incluidas 325 del maestro exacto):
