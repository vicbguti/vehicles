# La tabla comparativa de los cinco modelos no se puede construir hoy

> **Interno — no va al reporte.** Para Víctor y Nicolás.
>
> En [`05_hallazgos_para_el_equipo.md`](05_hallazgos_para_el_equipo.md) §7, la consolidación de
...
[`06_canonicalizacion_y_etiquetado.md`](06_canonicalizacion_y_etiquetado.md). Sin canonicalizar,
